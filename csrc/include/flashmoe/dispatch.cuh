...
namespace flashmoe {
    ...
    void dispatch(const int& H, const int& E,
        ...
        const int& superBlockSize, const int& blocks, const Element* __restrict__ const& tokens, // [S, H]
        ...
        const PBDispatch& producerBitMap, // [World, num_local_experts]
            ...
            if (routedTokens) {
                ...
                if (!threadIdx.x) {
                    ...
                    if (dS.fetch_add(1, cuda::memory_order_acq_rel) + 1 == superBlockSize) {
                        ...
                        const auto prevBit = producerBitMap(lI.peer, lI.expertLocalIdx);
                        const auto producerBit = prevBit == 0 ? 1 : 0;
                        producerBitMap(lI.peer, lI.expertLocalIdx) = producerBit;
